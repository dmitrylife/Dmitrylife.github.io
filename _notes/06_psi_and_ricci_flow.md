...
It does not modify gravity.
It does not introduce new fields.
It does not postulate microscopic dynamics.
...
This choice has a nontrivial consequence:
it endows the space of expansion histories with **geometry**.
...
Ψ(z) is not a field —
it is a **coordinate revealing structure**.

---

## Closing perspective

Once the data are placed in the right geometric language,
their behavior becomes simple.
