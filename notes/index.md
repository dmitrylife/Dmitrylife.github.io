...
Imagine a long moving surface,  
with a small object resting on it.

At first, everything moves together.  
Relative to the surface, the object is at rest.

Now the surface begins to slow down.

The object has inertia —  
it cannot instantly adjust.
...
But nothing was pushed forward.  
The system simply did not slow down fast enough.

---

This is the key idea:

**what appears as acceleration  
...
the larger the apparent recession speed.

This is not different forces acting on different objects —  
...
Matter attracts itself  
and tends to slow down the expansion.

At the same time,  
as the Universe expands,  
matter becomes more dilute.

Gravitational slowing weakens over time.

So the system is not static —  
its conditions continuously change.
...
More distant objects correspond  
to earlier cosmic epochs.
...
So we need a way to compare  
different moments in cosmic history.
...
- Ψ(z) describes deviations from the model  
  at those same epochs  
...
They explain why certain phenomena may admit  
effective or emergent interpretations  
...
All quantitative results, tests, and claims  
remain confined to the peer-reviewed and archived technical work.
