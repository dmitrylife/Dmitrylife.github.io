...
It deflects moving objects on a rotating planet.
...
their influence does not vanish.
It reappears as a systematic term in the reduced equations.

This is not an approximation error — it is a structural feature of macroscopic descriptions.

In thermodynamics, this is unavoidable.
In fluid dynamics, it is routine.
In non-equilibrium systems, it is the rule rather than the exception.
...
Data does not ask why a deviation exists.
It only reveals **regularity**.
