...
0. Small deviations are expected, not alarming
0. Coherence across datasets is more important than magnitude
0. New physics should first be sought in **state-space structure**, not in new interactions
0. Diagnostics may be more powerful than extensions
